Feature: Manage meta
  ...
  Scenario: Delete meta
    Given the following meta:
      |descripcion|duracion_estimada|duracion_real|estado|
      |descripcion 1|duracion_estimada 1|duracion_real 1|estado 1|
      |descripcion 2|duracion_estimada 2|duracion_real 2|estado 2|
      |descripcion 3|duracion_estimada 3|duracion_real 3|estado 3|
      |descripcion 4|duracion_estimada 4|duracion_real 4|estado 4|
    When I delete the 3rd meta
    Then I should see the following meta:
      |Descripcion|Duracion estimada|Duracion real|Estado|
      |descripcion 1|duracion_estimada 1|duracion_real 1|estado 1|
      |descripcion 2|duracion_estimada 2|duracion_real 2|estado 2|
      |descripcion 4|duracion_estimada 4|duracion_real 4|estado 4|
