  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "redirects to the created metum" do
        post :create, {:metum => valid_attributes}, valid_session
        response.should redirect_to(Metum.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved metum as @metum" do
        ...
        post :create, {:metum => { "detalle" => "invalid value" }}, valid_session
        assigns(:metum).should be_a_new(Metum)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested metum" do
        ...
        Metum.any_instance.should_receive(:update_attributes).with({ "detalle" => "MyString" })
        put :update, {:id => metum.to_param, :metum => { "detalle" => "MyString" }}, valid_session
      end
      ...
      it "redirects to the metum" do
        metum = Metum.create! valid_attributes
        put :update, {:id => metum.to_param, :metum => valid_attributes}, valid_session
        response.should redirect_to(metum)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the metum as @metum" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Metum.any_instance.stub(:save).and_return(false)
        put :update, {:id => metum.to_param, :metum => { "detalle" => "invalid value" }}, valid_session
        assigns(:metum).should eq(metum)
      end
