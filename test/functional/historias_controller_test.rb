...
class HistoriasControllerTest < ActionController::TestCase
  ...
  test "should create historia" do
    assert_difference('Historia.count') do
      post :create, historia: { detalle: @historia.detalle, duracion: @historia.duracion, estado: @historia.estado }
    end
  ...
  test "should update historia" do
    put :update, id: @historia, historia: { detalle: @historia.detalle, duracion: @historia.duracion, estado: @historia.estado }
    assert_redirected_to historia_path(assigns(:historia))
  end
